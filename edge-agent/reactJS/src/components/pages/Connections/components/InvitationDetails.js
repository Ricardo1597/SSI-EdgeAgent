...
export class InvitationDetails extends Component {
    ...
    render() {
        ...
        const { alias, invitationId, isMultiuse, timesUsed, myDid, myVerkey, isPublic, isActive, invitation } = this.props.invitation;
        return (
            <div>
                <CardContent>
...
export default connect(mapStateToProps)(withStyles(useStyles)(InvitationDetails));