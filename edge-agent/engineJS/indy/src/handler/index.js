...
module.exports = function(config) { //factory function creates object and returns it.
    ...
    if(config.defaultHandlers) {
        ...
        factory.defineHandler(indy.trustPing.MessageType.TrustPing, indy.trustPing.handlers.trustPingHandler);
        factory.defineHandler(indy.trustPing.MessageType.TrustPingResponse, indy.trustPing.handlers.trustPingResponseHandler);
        ...
        factory.defineHandler(indy.presentationExchange.MessageType.ProblemReport, indy.presentationExchange.handlers.problemReportHandler);
    }
    ...
    factory.defineHandler(indy.trustPing.NewMessageType.TrustPing, indy.trustPing.handlers.trustPingHandler);
    factory.defineHandler(indy.trustPing.NewMessageType.TrustPingResponse, indy.trustPing.handlers.trustPingResponseHandler);
    ...
    factory.defineHandler(indy.presentationExchange.NewMessageType.ProblemReport, indy.presentationExchange.handlers.problemReportHandler);
