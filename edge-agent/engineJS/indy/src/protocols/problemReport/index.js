...
exports.sendProblemReport = async (
  record,
  recordId,
  rejectError,
  impact,
  ...
  const [message, endpoint] = await indy.messages.prepareMessage(problemReportMessage, connection);
  ...
  await indy.wallet.updateWalletRecordValue(recordType, recordId, JSON.stringify(record));
