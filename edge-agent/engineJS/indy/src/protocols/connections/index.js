...
exports.receiveInvitation = async (myAlias, invitation, autoAccept = false) => {
  ...
  await this.addConnection(connection.connectionId, JSON.stringify(connection), {});
...
exports.getAllInvitations = async () => {
  return await indy.wallet.searchWalletRecord(indy.recordTypes.RecordType.Invitation, {}, {});
};

exports.removeInvitation = async (invitationId) => {
  return await indy.wallet.deleteWalletRecord(indy.recordTypes.RecordType.Invitation, invitationId);
};
